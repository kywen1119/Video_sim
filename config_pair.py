...
# ========================= Dataset Configs ==========================
parser.add_argument('--train-record-pattern', type=str, default='data/pairwise/0-5999val/train.tfrecords')
parser.add_argument('--val-record-pattern', type=str, default='data/pairwise/0-5999val/val.tfrecords')
...
parser.add_argument('--savedmodel-path', type=str, default='save/ft_pair')
parser.add_argument('--pretrain_model_dir', type=str, default='save/pair_1')
parser.add_argument('--ckpt-file', type=str, default='save/pair_1/ckpt-40000')
