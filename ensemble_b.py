...
def mix_roformer_asl():
    output_json = 'result.json'
    output_zip = 'result_10fold_mix_roformer_asl.zip'
    out_emb = {}
    with open('10fold_b_json/10fold_1_mix_roformer_asl.json', 'r') as f:
        vid_emb_1 = json.load(f)
    with open('10fold_b_json/10fold_2_mix_roformer_asl.json', 'r') as f:
        vid_emb_2 = json.load(f)
    with open('10fold_b_json/10fold_3_mix_roformer_asl.json', 'r') as f:
        vid_emb_3 = json.load(f)
    with open('10fold_b_json/10fold_4_mix_roformer_asl.json', 'r') as f:
        vid_emb_4 = json.load(f)
    with open('10fold_b_json/10fold_5_mix_roformer_asl.json', 'r') as f:
        vid_emb_5 = json.load(f)
    with open('10fold_b_json/10fold_6_mix_roformer_asl.json', 'r') as f:
        vid_emb_6 = json.load(f)
    with open('10fold_b_json/10fold_7_mix_roformer_asl.json', 'r') as f:
        vid_emb_7 = json.load(f)
    with open('10fold_b_json/10fold_8_mix_roformer_asl.json', 'r') as f:
        vid_emb_8 = json.load(f)
    with open('10fold_b_json/10fold_9_mix_roformer_asl.json', 'r') as f:
        vid_emb_9 = json.load(f)
    with open('10fold_b_json/10fold_10_mix_roformer_asl.json', 'r') as f:
        vid_emb_10 = json.load(f)
    with open('10fold_b_json/10fold_11_mix_roformer_asl.json', 'r') as f:
        vid_emb_11 = json.load(f)
    for key in vid_emb_1:
