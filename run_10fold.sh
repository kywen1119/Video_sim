...
# echo fold1! 0-5999val
# yes CUDA_VISIBLE_DEVICES=2 python train_pair_uniter_tag_asl.py --batch-size 128 --uniter-pooling mean --savedmodel-path save/10fold/10fold_1_uniter_mlm_tag_mean_kl_asl --pretrain_model_dir save/uniter_mlm_tag_256_mean_asl --kl-weight 0.5 --total-steps 3000 --train-record-pattern data/pairwise/0-5999val/train.tfrecord --val-record-pattern data/pairwise/0-5999val/val.tfrecord
# echo fold2! 6000-11999val
# yes CUDA_VISIBLE_DEVICES=2 python train_pair_uniter_tag_asl.py --batch-size 128 --uniter-pooling mean --savedmodel-path save/10fold/10fold_2_uniter_mlm_tag_mean_kl_asl --pretrain_model_dir save/uniter_mlm_tag_256_mean_asl --kl-weight 0.5 --total-steps 3000 --train-record-pattern data/pairwise/6000-11999val/train.tfrecord --val-record-pattern data/pairwise/6000-11999val/val.tfrecord
# echo fold3! 12000-17999val
# yes CUDA_VISIBLE_DEVICES=2 python train_pair_uniter_tag_asl.py --batch-size 128 --uniter-pooling mean --savedmodel-path save/10fold/10fold_3_uniter_mlm_tag_mean_kl_asl --pretrain_model_dir save/uniter_mlm_tag_256_mean_asl --kl-weight 0.5 --total-steps 3000 --train-record-pattern data/pairwise/12000-17999val/train.tfrecord --val-record-pattern data/pairwise/12000-17999val/val.tfrecord
# echo fold4! 18000-23999val
# yes CUDA_VISIBLE_DEVICES=2 python train_pair_uniter_tag_asl.py --batch-size 128 --uniter-pooling mean --savedmodel-path save/10fold/10fold_4_uniter_mlm_tag_mean_kl_asl --pretrain_model_dir save/uniter_mlm_tag_256_mean_asl --kl-weight 0.5 --total-steps 3000 --train-record-pattern data/pairwise/18000-23999val/train.tfrecord --val-record-pattern data/pairwise/18000-23999val/val.tfrecord
# echo fold5! 24000-29999val
# CUDA_VISIBLE_DEVICES=2 python train_pair_uniter_tag_asl.py --batch-size 128 --uniter-pooling mean --savedmodel-path save/10fold/10fold_5_uniter_mlm_tag_mean_kl_asl --pretrain_model_dir save/uniter_mlm_tag_256_mean_asl --kl-weight 0.5 --total-steps 3000 --train-record-pattern data/pairwise/24000-29999val/train.tfrecord --val-record-pattern data/pairwise/24000-29999val/val.tfrecord
# echo fold6! 30000-35999val
# CUDA_VISIBLE_DEVICES=2 python train_pair_uniter_tag_asl.py --batch-size 128 --uniter-pooling mean --savedmodel-path save/10fold/10fold_6_uniter_mlm_tag_mean_kl_asl --pretrain_model_dir save/uniter_mlm_tag_256_mean_asl --kl-weight 0.5 --total-steps 3000 --train-record-pattern data/pairwise/30000-35999val/train.tfrecord --val-record-pattern data/pairwise/30000-35999val/val.tfrecord
# echo fold7! 36000-41999val
# CUDA_VISIBLE_DEVICES=2 python train_pair_uniter_tag_asl.py --batch-size 128 --uniter-pooling mean --savedmodel-path save/10fold/10fold_7_uniter_mlm_tag_mean_kl_asl --pretrain_model_dir save/uniter_mlm_tag_256_mean_asl --kl-weight 0.5 --total-steps 3000 --train-record-pattern data/pairwise/36000-41999val/train.tfrecord --val-record-pattern data/pairwise/36000-41999val/val.tfrecord
# echo fold8! 42000-47999val
# CUDA_VISIBLE_DEVICES=2 python train_pair_uniter_tag_asl.py --batch-size 128 --uniter-pooling mean --savedmodel-path save/10fold/10fold_8_uniter_mlm_tag_mean_kl_asl --pretrain_model_dir save/uniter_mlm_tag_256_mean_asl --kl-weight 0.5 --total-steps 3000 --train-record-pattern data/pairwise/42000-47999val/train.tfrecord --val-record-pattern data/pairwise/42000-47999val/val.tfrecord
# echo fold9! 48000-53999val
# CUDA_VISIBLE_DEVICES=2 python train_pair_uniter_tag_asl.py --batch-size 128 --uniter-pooling mean --savedmodel-path save/10fold/10fold_9_uniter_mlm_tag_mean_kl_asl --pretrain_model_dir save/uniter_mlm_tag_256_mean_asl --kl-weight 0.5 --total-steps 3000 --train-record-pattern data/pairwise/48000-53999val/train.tfrecord --val-record-pattern data/pairwise/48000-53999val/val.tfrecord
# echo fold10! 54000-59999val
# CUDA_VISIBLE_DEVICES=2 python train_pair_uniter_tag_asl.py --batch-size 128 --uniter-pooling mean --savedmodel-path save/10fold/10fold_10_uniter_mlm_tag_mean_kl_asl --pretrain_model_dir save/uniter_mlm_tag_256_mean_asl --kl-weight 0.5 --total-steps 3000 --train-record-pattern data/pairwise/54000-59999val/train.tfrecord --val-record-pattern data/pairwise/54000-59999val/val.tfrecord
# echo fold11! 60000-65999val
# CUDA_VISIBLE_DEVICES=2 python train_pair_uniter_tag_asl.py --batch-size 128 --uniter-pooling mean --savedmodel-path save/10fold/10fold_11_uniter_mlm_tag_mean_kl_asl --pretrain_model_dir save/uniter_mlm_tag_256_mean_asl --kl-weight 0.5 --total-steps 3000 --train-record-pattern data/pairwise/60000-65999val/train.tfrecord --val-record-pattern data/pairwise/60000-65999val/val.tfrecord
