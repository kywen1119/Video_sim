...
class MultiModal(Model):
    def __init__(self, config, *args, **kwargs):
        ...
        self.classifier_category_id_1 = tf.keras.layers.Dense(40)
        self.classifier_category_id_2 = tf.keras.layers.Dense(23)
    ...
    def call(self, inputs, **kwargs):
        ...
        pre_cate_1 = self.classifier_category_id_1(final_embedding)
        pre_cate_2 = self.classifier_category_id_2(final_embedding)

        return predictions, final_embedding, vision_embedding, bert_embedding, pre_cate_1, pre_cate_2
    ...
    def get_variables(self):
        if not self.all_variables:  # is None, not initialized
            ...
            self.normal_variables = self.nextvlad.trainable_variables + self.fusion.trainable_variables + \
                                    ...
                                    self.classifier_category_id_1.trainable_variables + self.classifier_category_id_2.trainable_variables
