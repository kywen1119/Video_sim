...
python inference_pair_roformer_b.py --bert-dir junnyu/roformer_chinese --bert-seq-length 32 --ckpt-file final_save/10fold_1_mix_roformer/ckpt-4015 --output-zip 10fold_b_zip/10fold_1_mix_roformer.zip --output-json 10fold_b_json/10fold_1_mix_roformer.json
python inference_pair_roformer_b.py --bert-dir junnyu/roformer_chinese --bert-seq-length 32 --ckpt-file final_save/10fold_2_mix_roformer/ckpt-4015 --output-zip 10fold_b_zip/10fold_2_mix_roformer.zip --output-json 10fold_b_json/10fold_2_mix_roformer.json
python inference_pair_roformer_b.py --bert-dir junnyu/roformer_chinese --bert-seq-length 32 --ckpt-file final_save/10fold_3_mix_roformer/ckpt-4015 --output-zip 10fold_b_zip/10fold_3_mix_roformer.zip --output-json 10fold_b_json/10fold_3_mix_roformer.json
python inference_pair_roformer_b.py --bert-dir junnyu/roformer_chinese --bert-seq-length 32 --ckpt-file final_save/10fold_4_mix_roformer/ckpt-4015 --output-zip 10fold_b_zip/10fold_4_mix_roformer.zip --output-json 10fold_b_json/10fold_4_mix_roformer.json
python inference_pair_roformer_b.py --bert-dir junnyu/roformer_chinese --bert-seq-length 32 --ckpt-file final_save/10fold_5_mix_roformer/ckpt-4015 --output-zip 10fold_b_zip/10fold_5_mix_roformer.zip --output-json 10fold_b_json/10fold_5_mix_roformer.json
python inference_pair_roformer_b.py --bert-dir junnyu/roformer_chinese --bert-seq-length 32 --ckpt-file final_save/10fold_6_mix_roformer/ckpt-4015 --output-zip 10fold_b_zip/10fold_6_mix_roformer.zip --output-json 10fold_b_json/10fold_6_mix_roformer.json
python inference_pair_roformer_b.py --bert-dir junnyu/roformer_chinese --bert-seq-length 32 --ckpt-file final_save/10fold_7_mix_roformer/ckpt-4015 --output-zip 10fold_b_zip/10fold_7_mix_roformer.zip --output-json 10fold_b_json/10fold_7_mix_roformer.json
python inference_pair_roformer_b.py --bert-dir junnyu/roformer_chinese --bert-seq-length 32 --ckpt-file final_save/10fold_8_mix_roformer/ckpt-4015 --output-zip 10fold_b_zip/10fold_8_mix_roformer.zip --output-json 10fold_b_json/10fold_8_mix_roformer.json
python inference_pair_roformer_b.py --bert-dir junnyu/roformer_chinese --bert-seq-length 32 --ckpt-file final_save/10fold_9_mix_roformer/ckpt-4015 --output-zip 10fold_b_zip/10fold_9_mix_roformer.zip --output-json 10fold_b_json/10fold_9_mix_roformer.json
python inference_pair_roformer_b.py --bert-dir junnyu/roformer_chinese --bert-seq-length 32 --ckpt-file final_save/10fold_10_mix_roformer/ckpt-4015 --output-zip 10fold_b_zip/10fold_10_mix_roformer.zip --output-json 10fold_b_json/10fold_10_mix_roformer.json
python inference_pair_roformer_b.py --bert-dir junnyu/roformer_chinese --bert-seq-length 32 --ckpt-file final_save/10fold_11_mix_roformer/ckpt-4015 --output-zip 10fold_b_zip/10fold_11_mix_roformer.zip --output-json 10fold_b_json/10fold_11_mix_roformer.json
